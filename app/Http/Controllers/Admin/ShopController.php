...
class ShopController extends Controller
{
    ...
    public function add_products()
    {
        ...
        return view('admin.products-management.add')->with('title','Add Products')->with(compact('categories'))->with('products_menu',true);
    }
    ...
    public function edit_products($slug)
    {
        ...
        // dd($product);
        $categories = Category::where('is_active',1)->get();
        return view('admin.products-management.edit')->with('title','Edit Product')->with('products_menu',true)->with(compact('product','categories'));
    }
