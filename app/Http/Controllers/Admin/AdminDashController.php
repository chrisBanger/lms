...
class AdminDashController extends Controller
{
    ...
    {
        $reviews = Review::with(['reviewBelongsToUser','reviewBelongsToProducts','reviewBelongsToMerchandise'])->get();
    ...
    {
        $blog = Blog::get();
        return view('admin.blog-management.list')->with('title','News Management')->with('blog_menu',true)->with(compact('blog'));
    }
     ...
     $check_slug = Blog::where('slug',$request->slug)->where('id','!=',$request->id)->first();
       ...
       //dd($check_slug);
        ...
        if(request()->hasFile('thumbnails')){
          ...
          return redirect()->route('admin.blog_listing')->with('notify_success','News Created Successfuly!!');
    }

    public function edit_blog($id)
    {
        $blog = Blog::where('id',$id)->first();
        return view('admin.blog-management.edit')->with('title','Edit News')->with('blog_menu',true)->with(compact('blog'));
    }
    ...
    //    dd($request->all());
        ...
        if(request()->hasFile('thumbnails')){
          ...
          return redirect()->route('admin.blog_listing')->with('notify_success','News Updated Successfuly!!');
    }
  ...
  if ($validator->passes()) {  
        ...
        if(request()->hasFile('avatar')){
            ...
            $img = User::where('id',$user->id)->update([
                'img_path' => $avatar
            ]);
    ...
    public function saveprofile(Request $request)
    {
        ...
        if(request()->hasFile('avatar')){
            ...
            $img = User::where('id',$request->id)->update([
                'img_path' => $avatar
            ]);
            // $img = Manager::where('id',$request->id)->update([
            //     'img_path' => $avatar
            // ]);
