                    ...
                    <form id="add-record-form"   class="main-form mc-b-3">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="width" id="width"  value="{{$product->width}}" min="1" required class="form-control" placeholder="Enter Width in Inches">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="form-group">
                                    <label>Height (inches)*:</label>
                                    <input type="number" name="height" id="height"  value="{{$product->height}}" min="1" required class="form-control" placeholder="Enter Height in Inches">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="form-group">
                                    <label>Depth (inches)*:</label>
                                    <input type="number" name="depth" id="depth"  value="{{$product->depth}}" min="1" required class="form-control" placeholder="Enter Depth in Inches">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="form-group">
                                    <label>Weight (pound)*:</label>
                                    <input type="number" name="weight_pound" id="weight_pound"  value="{{$product->weight_pound}}" min="1" required class="form-control" placeholder="Enter Weight in Pound">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="form-group">
                                    <label>Weight (kg)*:</label>
                                    <input type="number" name="weight_kg" id="weight_kg"  value="{{$product->weight_kg}}" min="1" required class="form-control" placeholder="Enter Weight in Kg">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control ckeditor" id="editor3"  placeholder="Enter Info Description">{{$product->info_desc}}</textarea>
                        ...
                        <div class="col-lg-12 text-center">
                            ...
                            <div class="img-upload-wrapper  mc-b-3">
                              ...
                              <figure><img src="{{asset($product->productsHasMultiImages[0]->img_path)}}" class="thumbnail-img other_image" alt="user-img"></figure>
