...
<div class="main-sec">
    <div class="main-wrapper">
        ...
        <div class="user-wrapper">
            <form id="add-record-form" action="{{route('admin.savecourse')}}" enctype="multipart/form-data"
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            <label>Pages*:</label>
                            <input type="number" min="1" name="pages" value="{{$course->pages}}" required
                                class="form-control" placeholder="Enter No. of Pages">
                            @if ($errors->has('pages'))
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            <label>Hours*:</label>
                            <input type="number" min="1" name="hours" value="{{$course->hours}}" required
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            <label>Price $*:</label>
                            <input type="number" min="1" name="price" value="{{$course->price}}" required
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="date" name="effective_date" id="effective_date"
                                value="{{$course->effective_date}}" required class="form-control"
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="date" name="expiration_date" id="expiration_date"
                                value="{{$course->expiration_date}}" required class="form-control"
                                placeholder="Enter Date">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <select name="state" id="state" required class="form-control">
                                ...
                                <option {{$course->state_id == $state->id ? 'selected' : ''}} value="{{$state->id}}">
                                    {{$state->name}}</option>
                                @endforeach
                            </select>
                            @if ($errors->has('state'))
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="book_purchase_price" id="book_purchase_price" value="{{$course->book_purchase_price}}" required
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="book_rental_price" id="book_rental_price" value="{{$course->book_rental_price}}" required
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="form-control ckeditor" id="editor1"
                                placeholder="Enter Short Description">{{$course->short_desc}}</textarea>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="form-control ckeditor" id="editor2"
                                placeholder="Enter Long Description">{{$course->long_desc}}</textarea>
...
@if(!empty($course->file_path))
                        <a href="{{$course->file_path}}" class="primary-btn primary-bg" download>PDF download
</a>
@endif
                    </div>
