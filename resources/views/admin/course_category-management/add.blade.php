                ...
                <div class="row align-items-center mc-b-3">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="primary-heading color-dark">
                            <h2>Add License Category</h2>
                        </div>
                    </div>
                   
                </div>
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.create_course_category')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" id="title" required class="form-control" placeholder="Enter Title">{{old('title')}}</textarea>
                                    @if ($errors->has('title'))
