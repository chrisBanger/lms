                ...
                <div class="row justify-content-end">
                    <div class="col-lg-6">
                        <div class="primary-heading color-light">
                            <?php App\Helpers\Helper::inlineEditable("h2",["class"=>""],'SHOP DETAILS','SHOPDETTXT1');?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mc-b-4">
                <div class="col-lg-6 col-12">
                    <div class="for-slider mc-b-1">
                        @foreach($product->productsHasMultiImages as $p)
                ...
                <div class="col-lg-6 col-12">
                    <div class="product-detail-content">
                        <h3 class="mc-b-1">{{ucfirst($product->name)}}</h3>
                        <div class="review-wrapper d-flex align-items-center mc-b-2">
                            ...
                            <?php $count = App\Models\Review::where('item_id',$product->id)->where('type',1)->count();?>
                            <span class="color-primary">({{$count >= 1 ? $count.' '.'reviews' : 'No Reviews Yet'}})</span>
                        </div>
                        <h4 class=" mc-b-2">${{$product->price}}</h4>
                       ...
                       <?php echo html_entity_decode($product->short_desc)?>
                        <div class="row align-items-center mc-b-3">
                            ...
                            <div class="col-md-9 col-xs-12">
                                <a href="javascript:void(0)" id="cart-btn" class="primary-btn primary-bg" data-id="{{$product->id}}">Add To Cart</a>
                        ...
                        <div class="product-detail-list">
                            ...
                            <div class="product-detail-list-item">
                                <p>Dimension:</p>
                                <span>W {{$product->width}}” D {{$product->depth}}” H {{$product->height}}”</span>
                            </div>
                            <div class="product-detail-list-item">
                                <p>Weight:</p>
                                <span>{{$product->weight_pound}} lbs. ({{$product->weight_kg}} kgs.)</span>
                            </div>
                            <div class="product-detail-list-item">
                                <p>Share on:</p>
                                <span>
                        ...
                        <div class="tab-content mc-b-5">
                            <div class="tab-pane active show fade" id="description" role="tabpanel">
                                ...
                                <?php echo html_entity_decode($product->long_desc)?>
                                        <?php App\Helpers\Helper::inlineEditable("h2",["class"=>"mc-b-2"],'MERCHANDISE 2021/22','SHOPDETTXT2');?>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="information" role="tabpanel">
                                <div class="primary-heading color-dark">
                                <?php echo html_entity_decode($product->info_desc)?>
                            ...
                            <div class="tab-pane fade" id="review" role="tabpanel">
                                <div class="primary-heading color-dark">
                                <?php App\Helpers\Helper::inlineEditable("h4",["class"=>"mc-b-2"],'Product Reviews','SHOPDETTXT3');?>
                                <?php App\Helpers\Helper::inlineEditable("p",["class"=>""],'Write a Review','SHOPDETTXT4');?>
                                ...
                                <div class="main-form review-form">
